...
** rtype
** File description:
** PlayerShotSystem.hpp
*/

#ifndef PLAYER_SHOT_SYSTEM_HPP
#define PLAYER_SHOT_SYSTEM_HPP
...
private:
    void summonArrow(const float& angle, const float& x, const float& y) const
    {
        ...
        _registry.addComponent(arrow, Hitbox{
            ...
            .onCollision = [this] (const Entity& entity) { //std::cout << "Arrow hit something" << std::endl;
