...
public:
     ...
     */
    NetworkedScene(ISceneManager& manager, const std::string& name, asio::io_context& io_context, std::uint32_t port = 0)
        : AScene(manager, name), NetworkAgent(io_context, port)
    {}
