...
#include "PremadeComponents/Shapes/Circle.hpp"
...
class DrawShapeSystem final : public ARenderSystem {
  public:
    ...
    void execute(sf::RenderWindow& window) override {
        ...
        _registry.view<shape::Rectangle, Transform>().each([&](const ecs::Entity& entity, const shape::Rectangle& rect, const Transform& transform) {
        ...
        _registry.view<shape::Circle, Transform>().each([&](const ecs::Entity& entity, const shape::Circle& circle, const Transform& transform) {
