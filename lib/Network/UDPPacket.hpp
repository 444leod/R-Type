...
struct UDPPacket {
    ...
    class Exception final : public std::exception {
      public:
         ...
         */
        explicit Exception(const std::string& message, const char* function = __builtin_FUNCTION(), const int line = __builtin_LINE()) : _message(message + " in function: " + function + " at line: " + std::to_string(line)) {}
        /**
