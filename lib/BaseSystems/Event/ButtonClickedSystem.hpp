...
#include "BaseSystems/Abstracts/AEventSystem.hpp"
...
{
public:
    explicit ButtonClickedSystem(ecs::Registry &registry) : AEventSystem(registry, "ButtonClickedSystem") {}
    ...
    void execute(sf::Event& event) override
    {
        ...
        _registry.view<Transform, Button>().each([&] (Entity, const Transform& transform, const Button& button) {
