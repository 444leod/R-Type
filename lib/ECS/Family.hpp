...
template <typename T> struct GENERATOR_API Family
{
    ...
    /**
     * @brief Returns the name of the raw type.
     *
     * This static constexpr method returns the name of the raw type
     * using the `final_type` structure.
     *
     * @return The name of the raw type as a std::string.
     */
    static constexpr std::string name() { return final_type<Type>::name(); }
};
}
